...
class StarCraft2Env(MultiAgentEnv):
    ...
    def get_obs_agent(self, agent_id):
        ...
        if unit.health > 0:  # otherwise dead, return all zeros
            ...
            # Brings the direction in which movement is possible (East, West, South, North)
            ...
            for e_id, e_unit in self.enemies.items():
                ...
                # Information is stored only when it is within the range of one's vision.
                if (
    ...
    # Get partial observation information of all agents.
    def get_obs(self):
