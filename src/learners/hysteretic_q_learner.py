...
class QLearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        self.optimizer_alpha = Adam(params=self.params, lr=args.lr)
        self.optimizer_beta = Adam(params=self.params, lr=LR_BETA)
    ...
    def save_models(self, path):
        ...
        th.save(self.optimizer_alpha.state_dict(), f"{path}/opt_alpha.th")
        th.save(self.optimizer_beta.state_dict(), f"{path}/opt_beta.th")
    ...
    def load_models(self, path):
        ...
        self.optimizer_alpha.load_state_dict(th.load(f"{path}/opt_alpha.th", map_location=lambda storage, loc: storage))
        self.optimizer_beta.load_state_dict(th.load(f"{path}/opt_beta.th", map_location=lambda storage, loc: storage))